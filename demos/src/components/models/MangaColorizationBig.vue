            ...
            <v-layout row justify-center align-center class="mb-2">
                <v-flex xs5 md3 class="model-select">
                    ...
                    <v-select
                            ...
                            label="Manga-Colorization-Big Model"
                            max-height="750"
                    ></v-select>
                </v-flex>
            </v-layout>
...
<script>
    ...
    const MODEL_SELECT_LIST = [
        {text: 'gray-valley(7.9MB)', value: 'tf_GA_weights607000'},
        {text: 'orange-desert(7.9MB)', value: 'tf_GA_weights688500'},
        {text: 'blue-forest(7.9MB)', value: 'tf_GA_weights666500'},
        {text: 'red-sunset(7.9MB)', value: 'tf_GA_weights593000'},

    ]

    const DEV_FILEPATH_PREFIX = '/demos/data/manga_colorization_big/'
    const PROD_FILEPATH_PREFIX = '/demos/data/manga_colorization_big/'
