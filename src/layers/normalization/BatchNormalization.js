...
export default class BatchNormalization extends Layer {
    ...
    _callCPU(x) {
        ...
        // const cpu_weigths_mean =  this.weights['moving_mean'].tensor.data[0]
        // // // console.log('cpu_weigths_mean', cpu_weigths_mean)
    ...
    _callGPU(x) {
        ...
        // const weight_before_transfer = this.weights['moving_variance'].tensor.data[0]
        // // console.log('batch_norm_js weight_before_transfer', weight_before_transfer)
        // // console.log('batch_norm_js x', x)
